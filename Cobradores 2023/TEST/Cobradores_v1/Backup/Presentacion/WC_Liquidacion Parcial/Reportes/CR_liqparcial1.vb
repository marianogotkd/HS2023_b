...
Public Class CR_liqparcial1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CR_liqparcial1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_liqparcial1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_liqparcial1 = New CR_liqparcial1()
        rpt.Site = Me.Site
        Return rpt
    End Function
