...
<div class="card">
        ...
        <div class="row align-items-center">
            ...
            <div class="form-group">
              ...
              <asp:Button ID="BTN_IMPRIMIR" runat="server" Text="IMPRIMIR" class="btn btn-primary" onkeydown="tecla_op_botones(event);" OnClientClick="window.open('/WC_Reportes/Rpt/LiqFinal_TotalesFinales.pdf','_blank')" />
