...
Public Class LiquidacionFinal_informe01
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "LiquidacionFinal_informe01.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.LiquidacionFinal_informe01.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_var_PAGOCOBRORECLAMO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedLiquidacionFinal_informe01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LiquidacionFinal_informe01 = New LiquidacionFinal_informe01()
        rpt.Site = Me.Site
        Return rpt
    End Function
