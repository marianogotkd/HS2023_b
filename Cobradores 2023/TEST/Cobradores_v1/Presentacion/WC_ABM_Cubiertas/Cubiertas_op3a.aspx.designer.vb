...
Partial Public Class Cubiertas_op3a
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents Label_grupo As Global.System.Web.UI.WebControls.Label

    '''<summary>
    '''Control Txt_GrupoCod.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents Txt_GrupoCod As Global.System.Web.UI.WebControls.TextBox
