Public Class Cubiertas_op2b
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    If Not IsPostBack Then
      ...
      'recupero info de la cubierta si existe en GruposCub, donde tipo = 0
      Dim ds_info As DataSet = daCubiertas.GruposCub_BuscarOp2(CStr(Session("Codigo")))
  ...
  Private Sub btn_retroceder_ServerClick(sender As Object, e As EventArgs) Handles btn_retroceder.ServerClick
    ...
    Response.Redirect("~/WC_ABM_Cubiertas/Cubiertas_op2a.aspx")
  End Sub
  ...
  Private Sub BOTON_GRABA_ServerClick(sender As Object, e As EventArgs) Handles BOTON_GRABA.ServerClick
    ...
    If valido_ingreso = "si" Then
      If HF_IdCubGrupo.Value = 0 Then
        ...
        If ds_clie.Tables(0).Rows.Count <> 0 Then
          If HF_grupo_id.Value = ds_clie.Tables(0).Rows(0).Item("Grupo_id") Then
            ...
            daCubiertas.GruposCub_alta_op2(Txt_grupo_codigo.Text, exc1, exc2, exc3, exc4, Cliente_id, DropDownList_considerar.SelectedValue)
      ...
      Else
        ...
        daCubiertas.GruposCub_modificar_op2(HF_IdCubGrupo.Value, exc1, exc2, exc3, exc4, DropDownList_considerar.SelectedValue)
        ScriptManager.RegisterStartupScript(Page, Page.[GetType](), "modal-sm_OKGRABADO", "$(document).ready(function () {$('#modal-sm_OKGRABADO').modal();});", True)
      End If
    Else
  ...
  Private Sub btn_baja_mdll_ServerClick(sender As Object, e As EventArgs) Handles btn_baja_mdll.ServerClick
    Try
      If HF_IdCubGrupo.Value <> "0" Then
        daCubiertas.GruposCub_eliminar_op2(CInt(HF_IdCubGrupo.Value))
        Session("op_ingreso") = "si"
        Response.Redirect("~/WC_ABM_Cubiertas/Cubiertas_op2a.aspx")
      Else
        'mensaje error.
