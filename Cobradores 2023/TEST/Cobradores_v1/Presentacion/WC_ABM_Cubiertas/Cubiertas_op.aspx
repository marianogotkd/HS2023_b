<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Cubiertas_op.aspx.vb" Inherits="Presentacion.Cubiertas_op" %>
...
<div class="card-header">
                <h3 class="card-title">A.B.M. CUBIERTAS</h3>
</div>
<form role="form">
<div class="card-body">
...
<div class="card">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md" id="Div_Op1" runat="server" visible ="false">
                            <%--<asp:Label ID="Label1" runat="server" Text="1 - INDIVIDUAL DIVIDE EN EL MISMO CLIENTE."></asp:Label>--%>
                            <asp:LinkButton ID="LinkButton_op1" runat="server">1 - INDIVIDUAL DIVIDE EN EL MISMO CLIENTE.</asp:LinkButton>
                        </div>
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md" id="Div_Op2" runat="server" visible ="false">
                            <asp:LinkButton ID="LinkButton_op2" runat="server">2 - POR GRUPO A OTRO CLIENTE.</asp:LinkButton>
                            <%--<asp:Label ID="Label2" runat="server" Text="2 - POR GRUPO A OTRO CLIENTE."></asp:Label>--%>
                        </div>
                    </div>

                  <div class="row justify-content-center">
                          <div class="col-md" id="Div_Op3" runat="server" visible ="false">
                            <%--<asp:Label ID="Label3" runat="server" Text="3 - POR GRUPO A OTRO CLIENTE X IMPORTE TOTAL DEL REGISTRO."></asp:Label>--%>
                            <asp:LinkButton ID="LinkButton_op3" runat="server">3 - POR GRUPO A OTRO CLIENTE X IMPORTE TOTAL DE REGISTRO.</asp:LinkButton>
                        </div>
                  </div>


                  <div class="row justify-content-center">
                        <div class="col-md" id="Div_Op4" runat="server" visible ="false">
                            <%--<asp:Label ID="Label5" runat="server" Text="4 - GENERAL A OTRO CLIENTE."></asp:Label>--%>
                            <asp:LinkButton ID="LinkButton_op4" runat="server">4 - GENERAL A OTRO CLIENTE.</asp:LinkButton>
                        </div>
