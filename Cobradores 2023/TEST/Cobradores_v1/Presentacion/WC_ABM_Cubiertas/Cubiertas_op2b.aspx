<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Cubiertas_op2b.aspx.vb" Inherits="Presentacion.Cubiertas_op2b" %>
...
<ContentTemplate>
    <div class="card card-primary">
        <div class="card-header">
                <h3 class="card-title">A.B.M. CUBIERTAS - POR GRUPO A OTRO CLIENTE.</h3>
        </div>
    <form role="form">
    <div class="card-body">
