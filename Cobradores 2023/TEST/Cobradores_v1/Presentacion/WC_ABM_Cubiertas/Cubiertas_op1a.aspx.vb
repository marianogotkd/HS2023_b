Public Class Cubiertas_op1a
  ...
  Private Sub BOTON_GRABA_ServerClick(sender As Object, e As EventArgs) Handles BOTON_GRABA.ServerClick
    ...
    Dim ds_clie As DataSet = DAClientes.Clientes_buscar_codigo(Txt_ClienteCod.Text)
    If ds_clie.Tables(0).Rows.Count <> 0 Then
      'enviar el codigo del cliente y nombre.
      Session("Codigo") = ds_clie.Tables(0).Rows(0).Item("Codigo")
      Session("Nombre") = ds_clie.Tables(0).Rows(0).Item("Nombre")
      Session("op_ingreso") = "si"
      Response.Redirect("~/WC_ABM_Cubiertas/Cubiertas_op1b.aspx")
    Else
