<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="ReliquidacionXError.aspx.vb" Inherits="Presentacion.ReliquidacionXError" %>
...
<div class="card-header">
                <h3 class="card-title">RELIQUIDACION POR ERROR</h3>
</div>
<form role="form">
<div class="card-body">
    <div align="center">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                      <asp:Label ID="Label1" runat="server" Text="ESTA SEGURO QUE DESEEA RELIQUIDAR ESTE DIA?"></asp:Label>  
                        <br />
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Error, No existe fecha anterior. No se puede reliquidar.!&hellip;</p>
            </div>
...
<div class="modal fade" id="modal-ok" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Se restauro exitosamente.!&hellip;</p>
            </div>
            <div class="modal-footer justify-content-center ">
            <%--<div class="modal-footer justify-content-between">--%>
              <%--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>--%>
