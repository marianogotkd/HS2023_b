<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Listados_SaldoRegalo.aspx.vb" Inherits="Presentacion.Listados_SaldoRegalo" %>
    ...
    <ContentTemplate>
      <div class="card card-primary">
          <div class="card-header">
                <h3 class="card-title">LISTADO DE SALDOS Y REGALOS</h3>
          </div>
          <form role="form">
<div class="card-body">
...
<div class="card">
                        ...
                        <div class="row justify-content-center">
                                <div class="col-lg"> <%--antes col-4--%>
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="LABEL_FECHA" runat="server" Text="LISTADO DE SALDOS Y REGALOS HASTA LA FECHA:"></asp:Label>
                            ...
                            <asp:GridView ID="GridView1" runat="server" class="table table-head-fixed text-nowrap" AllowSorting="True" AutoGenerateColumns="False" 
                                  ...
                                  EnableSortingAndPagingCallbacks="True"> 
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Saldo_desc" HeaderText="" />
                                        <asp:BoundField DataField="Regalo" HeaderText="REGALO" />
                                        <asp:BoundField DataField="Regalo_desc" HeaderText="" />
        ...
        <div class="row align-items-center">
            ...
            <div class="form-group">
              ...
              <asp:Button ID="BTN_IMPRIMIR" runat="server" Text="IMPRIMIR" class="btn btn-primary" onkeydown="tecla_op_botones(event);" OnClientClick="window.open('/WC_Reportes/Rpt/ListadoSaldoRegalo.pdf','_blank')" />
