<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Listados_op.aspx.vb" Inherits="Presentacion.Listados_op" %>
                ...
                <div class="form-group">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4" id="Div_Op1" runat="server" visible ="false">
                            ...
                            <asp:LinkButton ID="LinkButton_1" runat="server">1 - LISTADO DE SALDOS Y REGALOS.</asp:LinkButton>
                        </div>
                        <div class="col-md-4" id="Div_Op2" runat="server" visible ="false">
                            <asp:LinkButton ID="LinkButton_2" runat="server">2 - LISTADO DE LOS QUE GANAN.</asp:LinkButton>
                      ...
                      <div class="col-md-4" id="Div_Op3" runat="server" visible ="false">
                            ...
                            <asp:LinkButton ID="LinkButton_3" runat="server">3 - LISTADO DE ENTRADAS Y SALIDAS.</asp:LinkButton>
                        </div>
