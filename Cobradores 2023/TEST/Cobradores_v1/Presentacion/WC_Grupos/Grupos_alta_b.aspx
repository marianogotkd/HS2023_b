...
<div class="card-body">
        ...
        <div class="form-group">
            <div class="row justify-content-center">
                    ...
                    Visible="False"></asp:Label>
                      <label for="Label_clientedeuda">Cliente Deuda:</label>
                      <asp:TextBox ID="Txt_clientedeuda" runat="server" placeholder="0" 
                            class="form-control" CausesValidation="True" validationgroup="check_2" xmlns:asp="#unknown2" 
                    MaxLength="4" onkeydown="tecla_op(event);" 
                            onkeypress="return justNumbers(event);"></asp:TextBox>
                      <asp:Label ID="lb_error_cliedeuda" runat="server" ForeColor="Red" Text="* El cliente no existe" 
                    Visible="False"></asp:Label>
                    </div>
        ...
        <div class="form-group">
            <div class="row justify-content-center">
                    <div class="col-md-4">
                    <label for="Label_codcobro">Cod.Cobro:</label>
        ...
        <div class="form-group">
            <div class="row justify-content-center">
                    <div class="col-md-4">
                    <label for="Label_fecha">Fecha de procesamiento(dd/mm/yyyy):</label>
                    ...
                    MaxLength="17" onkeydown="tecla_op(event);" onkeypress="return validateDecimalNegativoKeyPress(this, event);"></asp:TextBox>
                    </div>
                    <%--<div class="col-md-4">
                    </div>--%>
