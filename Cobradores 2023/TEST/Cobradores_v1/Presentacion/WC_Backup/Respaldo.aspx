<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Respaldo.aspx.vb" Inherits="Presentacion.Respaldo" %>
...
<div class="card-header">
                <h3 class="card-title">RESPALDO - BACKUP</h3>
</div>
<form role="form">
<div class="card-body">
    <div align="center">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                      <asp:Label ID="Label1" runat="server" Text="1 - Generar WebCentral.bak."></asp:Label>  
                        <br />
                      <asp:Label ID="Label5" runat="server" Text="2 - Generar WebCentral_copy.bak."></asp:Label>  
                        <br />
                    ...
                    <div class="form-group">
                      ...
                      <asp:Label ID="Label2" runat="server" Text="FECHA:" Visible="false"></asp:Label>
                      <asp:Label ID="Label_fecha" runat="server" Text="" Visible="false"></asp:Label>
                  ...
                  <div class="form-group">
                      <asp:Label ID="Label3" runat="server" Text="DIA:" Visible="false"></asp:Label>
                      <asp:Label ID="Label_dia" runat="server" Text="" Visible="false"></asp:Label>
...
<div class="modal fade" id="modal-ErrorValidacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  ...
  <div class="modal fade" id="modal-ok_descargando" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Mensaje</h4>
              <button type="button" id="Btn_download_close" runat="server" class="close" tabindex="-1" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <p>El archivo de respaldo se está descargando!&hellip;</p>
            </div>
            <div class="modal-footer justify-content-center ">
            <%--<div class="modal-footer justify-content-between">--%>
              <%--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>--%>
              <button type="button" id="Btn_download_ok" runat="server" class="btn btn-primary" data-dismiss="modal">OK</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
