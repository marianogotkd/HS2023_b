<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="VisRegAnt_a.aspx.vb" Inherits="Presentacion.VisRegAnt_a" %>
          ...
          <div class="row justify-content-center">
            <div class="col-md-4">
              <asp:HiddenField ID="HF_fecha" runat="server" />
                       ...
                       <label for="Label_fecha">INGRESE FECHA (dd/mm/yyyy):</label>        
