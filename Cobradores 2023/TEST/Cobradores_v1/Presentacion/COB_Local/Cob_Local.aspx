<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Cob_Local.aspx.vb" Inherits="Presentacion.Cob_Local" %>
...
<div class="card-body">
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="card-header">
                      <h3 class="card-title">LISTADO DE LOCALES REGISTRADOS:</h3>      
                                        ...
                                        <asp:TemplateField HeaderText="SELECC">
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="Button1" runat="server" Font-Bold="True" ForeColor="Black" 
                                                    Text="IR" Width="70px" CommandName="ID" CommandArgument='<%# Eval("LOCAL_ID") %>' />
                                            </ItemTemplate>
                                            <HeaderStyle ForeColor="#0099FF" />
                                        </asp:TemplateField>
