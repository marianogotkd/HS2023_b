<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="CodigoPremiado_consulta.aspx.vb" Inherits="Presentacion.CodigoPremiado_consulta" %>
        ...
        <div class="card-body">
                            ...
                            <asp:GridView ID="GridView1" runat="server" class="table table-head-fixed text-nowrap" AllowPaging="false" AllowSorting="True" AutoGenerateColumns="False" 
                                  ...
                                  EnableSortingAndPagingCallbacks="True"  ShowHeader="true"> 
                                    <Columns>
                                      ...
                                      <asp:BoundField DataField="Zona5" HeaderText="Zona" >                                                               
                                        <HeaderStyle ForeColor="#0099FF" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Importe5" HeaderText="Importe" >                                                               
                                        <HeaderStyle ForeColor="#0099FF" />
                                        </asp:BoundField>
          ...
          <div class="form-group">       
                  <div class="row justify-content-center">
                                      ...
                                      <div class="col-md-4">
                                                    <label for="lblImporte4">TOTAL RECAUDADO:</label>
                                                    <asp:TextBox ID="Txt_totalrecaudado" runat="server" class="form-control" placeholder="0,00" CausesValidation="True" validationgroup="check_2" xmlns:asp="#unknown2" MaxLength="17" onkeydown="tecla_op(event);" onkeypress="return validateDecimalKeyPress(this, event);"></asp:TextBox>
        ...
        <div class="row align-items-center">
          ...
          <%--<div class="form-group">
            ...
            <div class="form-group">
              ...
              <asp:Button ID="BTN_IMPRIMIR" runat="server" Text="IMPRIMIR" class="btn btn-primary" onkeydown="tecla_op_botones(event);" OnClientClick="window.open('/WC_Reportes/Rpt/CodigoPremiado.pdf','_blank')" />
