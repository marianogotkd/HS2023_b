<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="IngresoTerminales.aspx.vb" Inherits="Presentacion.IngresoTerminales" %>
...
<div class="card-header">
                <h3 class="card-title">INGRESO DE TERMINALES</h3>
</div>
        ...
        <div class="row justify-content-center" >
         ...
         <div class="row align-items-center">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                                <button type="button" Class="btn btn-primary" id = "btnImprimir" runat="server" onkeydown="tecla_op_botones(event);">F8 = IMPRIMIR</button>
