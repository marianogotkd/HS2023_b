Public Class TicketsClieRegenerar_op
    ...
    Select Case txt_opcion.Text.ToUpper
      Case "1"
        If Div_Op1.Visible = True Then
          Session("op_ingreso") = "si"
          Response.Redirect("~/WC_TicketsClientes/TicketsClieRegenerar_orden.aspx")
        Else
          txt_opcion.Focus()
        End If
      ...
      Case "2"
        If Div_Op2.Visible = True Then
          Session("op_ingreso") = "si"
          Response.Redirect("~/WC_TicketsClientes/TicketsClieRegenerar_recorridos.aspx")
        Else
          txt_opcion.Focus()
        End If
      Case Else
