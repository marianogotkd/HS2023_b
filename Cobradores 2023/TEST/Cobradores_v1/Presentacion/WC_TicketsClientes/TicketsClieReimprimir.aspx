<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="TicketsClieReimprimir.aspx.vb" Inherits="Presentacion.TicketsClieReimprimir" %>
...
<ContentTemplate>
    <div class="card card-primary">
        <div class="card-header">
                <h3 class="card-title">TICKETS CLIENTES REIMPRIMIR.</h3>
        </div>
    <form role="form">
    <div class="card-body">
        ...
        <div class="form-group">
          <div class="row justify-content-center">
            <div class="col-md-4">
              ...
              <label for="Label_fecha">FECHA A REIMPRIMIR (dd/mm/yyyy):</label>        
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Error, no hay liquidacion para la fecha ingresada!&hellip;</p>
            </div>
...
<div class="modal fade" id="modal-ok_error2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Error, ingrese fecha valida!&hellip;</p>
            </div>
            <div class="modal-footer justify-content-center ">
            <%--<div class="modal-footer justify-content-between">--%>
              <%--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>--%>
