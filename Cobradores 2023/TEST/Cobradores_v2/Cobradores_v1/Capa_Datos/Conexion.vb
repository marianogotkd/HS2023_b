...
Public Class Conexion
    ...
    'Public dbconnMaster As New OleDb.OleDbConnection("Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=Cobradores;Data Source=localhost")
    ...
    Public dbconn As New OleDb.OleDbConnection("Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=Cobradores;Data Source=STFARGAZ203-L\SQLEXPRESS")
    Public dbconnMaster As New OleDb.OleDbConnection("Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=Cobradores;Data Source=STFARGAZ203-L\SQLEXPRESS")
