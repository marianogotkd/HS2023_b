<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Descargando.aspx.vb" Inherits="Presentacion.Descargando" %>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                      <asp:Label ID="Label1" runat="server" Text="DESEA REALIZAR UN BACKUP?"></asp:Label>  
                        <br />
