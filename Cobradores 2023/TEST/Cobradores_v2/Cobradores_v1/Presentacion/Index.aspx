...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>WEB COBRADORES</b> </a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
           ...
           <div class="input-group mb-3">
            ...
            <div class="card bg-danger" visible="false" runat="server" id="lbl_Err2">
              <div class="card-header"  runat="server" id="Campos" >
                <h3 class="card-title">Usuario o Contrasena Incorrecta</h3>
              </div>                             
              </div>
             
             <div class="card bg-danger" visible="false" runat="server" id="lbl_Err3">
              <div class="card-header"  runat="server" id="Div2" >
                <h3 class="card-title">No tiene permisos</h3>
              </div>                             
              </div>
