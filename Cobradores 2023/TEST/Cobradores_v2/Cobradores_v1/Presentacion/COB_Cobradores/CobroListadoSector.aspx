<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="CobroListadoSector.aspx.vb" Inherits="Presentacion.CobroListadoSector" %>
...
<div class="card-header">
                <h3 class="card-title">COBRADORES - LISTADO SECTORES A COBRAR</h3>
</div>
<form role="form">
<div class="card-body">
                                  ...
                                  EnableSortingAndPagingCallbacks="True"> 
                                    <Columns>
                                      <asp:TemplateField HeaderText="">
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="BtnIR" runat="server" Font-Bold="True" ForeColor="Black" 
                                                    Text="IR" Width="40px" CommandName="ID" CommandArgument='<%# Eval("SECTOR_ID") %>' />
                                            </ItemTemplate>
                                      ...
                                      <asp:BoundField DataField="ITEM" HeaderText="ITEM" >                                                               
                                        ...
                                        <asp:BoundField DataField="SECTOR_desc" HeaderText="SECTOR" >                                                               
                                        <HeaderStyle ForeColor="#0099FF" />
                                        </asp:BoundField>
