<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Cob_usuarios.aspx.vb" Inherits="Presentacion.Cob_usuarios" %>
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="row justify-content-center">
                                    <div class="col-md-4">
                                        <label for="Label_cliente_id">LISTADO DE USUARIOS REGISTRADOS:</label>
                            ...
                            <asp:GridView ID="GridView1" runat="server" class="table table-head-fixed text-nowrap" AllowPaging="false" AllowSorting="True" AutoGenerateColumns="False" 
                                  ...
                                  EnableSortingAndPagingCallbacks="True"> 
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ApeNomb" HeaderText="Nombre" >
                                        <HeaderStyle ForeColor="#0099FF" />
                                        </asp:BoundField>

                                        <asp:BoundField DataField="Jerarquia" HeaderText="Jerarquia">
                                        <HeaderStyle ForeColor="#0099FF" />
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderText="SELECC">
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="Button1" runat="server" Font-Bold="True" ForeColor="Black" 
                                                    Text="IR" Width="70px" CommandName="ID" CommandArgument='<%# Eval("USU_ID") %>' />
                                            </ItemTemplate>
                                            <HeaderStyle ForeColor="#0099FF" />
                                        </asp:TemplateField>
