<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="LiquidacionRegalosMensual.aspx.vb" Inherits="Presentacion.LiquidacionRegalosMensual" %>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                      ...
                      <asp:Label ID="Label1" runat="server" Text="ESTA SEGURO DE REALIZAR LA LIQUIDACION MENSUAL?"></asp:Label>  
                        <br />
