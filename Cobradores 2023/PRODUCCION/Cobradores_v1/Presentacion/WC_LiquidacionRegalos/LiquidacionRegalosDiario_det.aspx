<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="LiquidacionRegalosDiario_det.aspx.vb" Inherits="Presentacion.LiquidacionRegalosDiario_det" %>
...
<div class="card">
                        ...
                        <div class="row justify-content-center">
                                <div class="col-lg"> <%--antes col-4--%>
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="LABEL_FECHA" runat="server" Text="LIQUIDACION DE REGALOS DIARIO PARA LA FECHA:"></asp:Label>
          ...
          <div class="form-group">
              <div class="row justify-content-center">
                ...
                <div class="card">
                  ...
                  <div>
                          <asp:Label ID="Label_noregalos" runat="server" Text="No se registro liquidacion diaria!" Visible="false" ForeColor="#6699FF"></asp:Label>
        ...
        <div class="row align-items-center">
            ...
            <div class="form-group">
            <asp:Button ID="BTN_IMPRIMIR" runat="server" Text="IMPRIMIR" class="btn btn-primary" onkeydown="tecla_op_botones(event);" OnClientClick="window.open('/WC_Reportes/Rpt/LiqRegalos_Diario.pdf','_blank')" />
            </div>
