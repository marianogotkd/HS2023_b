<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Cob_clientes.aspx.vb" Inherits="Presentacion.Cob_clientes" %>
                            ...
                            <asp:GridView ID="GridView1" runat="server" class="table table-head-fixed text-nowrap" AllowPaging="false" AllowSorting="True" AutoGenerateColumns="False" 
                                  ...
                                  EnableSortingAndPagingCallbacks="True"> 
                                    <Columns>
                                      ...
                                      <asp:BoundField DataField="CtaCte" HeaderText="CTACTE" >                                                               
                                        <HeaderStyle ForeColor="#0099FF" />
                                        </asp:BoundField>     
