<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Cob_CobroListado.aspx.vb" Inherits="Presentacion.Cob_CobroListado" %>
...
<div class="card-header">
                <h3 class="card-title">COBRADORES - LISTADO DE LOCALES A COBRAR</h3>
</div>
<form role="form">
<div class="card-body">
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
              <asp:HiddenField ID="HF_PASILLO_ID" runat="server" />
              <asp:HiddenField ID="HF_SECTOR_ID" runat="server" />
                    <%--<div class="card"> 2do cardo comentado--%>
                            <%--<div class="card-body"> 1er card comentado--%>
                            <%--<div class="form-group">
                            <div class="row justify-content-center">
                                    <div class="col-md-4">
                                        <label for="Label_cliente_id">LISTADO DE LOCALES REGISTRADOS:</label>
                    ...
                    <%--<div class="card-header">
                      <h3 class="card-title">LISTADO DE LOCALES A COBRAR:</h3>      
                    ...
                    <div class="card-body table-responsive p-0"  onkeydown="tecla_op_botones(event);"> <%--div class="form-group"--%>
                                  ...
                                  EnableSortingAndPagingCallbacks="True"> 
                                    <Columns>
                                      <asp:TemplateField HeaderText="">
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="BtnIR" runat="server" Font-Bold="True" ForeColor="Black" 
                                                    Text="IR" Width="40px" CommandName="ID" CommandArgument='<%# Eval("ITEM") %>' />
                                            </ItemTemplate>
                                      ...
                                      <asp:BoundField DataField="ITEM" HeaderText="ITEM" >                                                               
                                        ...
                                        <asp:BoundField DataField="CLIE_ID" HeaderText="CLIE_ID" >                                                               
                                        <HeaderStyle ForeColor="#0099FF" />
                                        </asp:BoundField>
                            ...
                            <%--</div> fin 1er card comentado--%>
                    <%--</div> fin 2do card comentado--%>
            </div>
            </div>
        </div>
</div>
