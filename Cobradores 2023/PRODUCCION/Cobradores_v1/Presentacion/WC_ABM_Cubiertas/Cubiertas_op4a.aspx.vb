Public Class Cubiertas_op4a
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    If Not IsPostBack Then
      ...
      'recupero info de la cubierta si existe en GruposCub, donde tipo = 2
      Dim ds_info As DataSet = daCubiertas.GruposCub_BuscarOp4()
      ...
      Select Case Jerarquia
        ...
        Case "2"
          ...
          While i < ds_permisos.Tables(0).Rows.Count
            ...
            Catch ex As Exception
            End Try
            If (Menu = "J" And Opcion = "") Or (Menu = "J" And Opcion = "4") Then
              valido = "si"
              Exit While
            End If
            i = i + 1
    ...
    If valido_ingreso = "si" Then
      If HF_IdCubGrupo.Value = 0 Then
        ...
        If ds_clie.Tables(0).Rows.Count <> 0 Then
          ...
          daCubiertas.GruposCub_alta_op4(exc1, exc2, exc3, exc4, Cliente_id, DropDownList_considerar.SelectedValue)
      ...
      Else
        ...
        daCubiertas.GruposCub_modificar_op4(HF_IdCubGrupo.Value, exc1, exc2, exc3, exc4, DropDownList_considerar.SelectedValue)
        ScriptManager.RegisterStartupScript(Page, Page.[GetType](), "modal-sm_OKGRABADO", "$(document).ready(function () {$('#modal-sm_OKGRABADO').modal();});", True)
      End If
    Else
  ...
  Private Sub btn_baja_mdll_ServerClick(sender As Object, e As EventArgs) Handles btn_baja_mdll.ServerClick
    Try
      If HF_IdCubGrupo.Value <> "0" Then
        daCubiertas.GruposCub_eliminar_op4(CInt(HF_IdCubGrupo.Value))
        Session("op_ingreso") = "si"
        Response.Redirect("~/WC_ABM_Cubiertas/Cubiertas_op.aspx")
      Else
        'mensaje error.
