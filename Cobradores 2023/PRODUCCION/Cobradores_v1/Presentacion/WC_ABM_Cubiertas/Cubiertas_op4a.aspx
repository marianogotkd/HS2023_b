<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Cubiertas_op4a.aspx.vb" Inherits="Presentacion.Cubiertas_op4a" %>
...
<ContentTemplate>
    <div class="card card-primary">
        <div class="card-header">
                <h3 class="card-title">A.B.M. CUBIERTAS - GENERAL A OTRO CLIENTE.</h3>
        </div>
    <form role="form">
    <div class="card-body">
