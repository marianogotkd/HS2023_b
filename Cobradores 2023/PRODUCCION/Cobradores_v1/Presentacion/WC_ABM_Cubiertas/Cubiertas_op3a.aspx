<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Cubiertas_op3a.aspx.vb" Inherits="Presentacion.Cubiertas_op3a" %>
...
<ContentTemplate>
    ...
    <div class="card-body">
        <div class="form-group">
          ...
          <div class="row justify-content-center">
            <div class="col-md-4">
              <asp:Label ID="Label_grupo" runat="server" Text="GRUPO:"></asp:Label>
                  <asp:TextBox ID="Txt_GrupoCod" runat="server" 
