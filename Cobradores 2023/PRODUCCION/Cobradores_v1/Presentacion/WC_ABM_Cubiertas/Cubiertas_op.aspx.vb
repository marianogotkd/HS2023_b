Public Class Cubiertas_op
    ...
    Select Case txt_opcion.Text.ToUpper
      ...
      Case "4"
        If Div_Op4.Visible = True Then
          Session("op_ingreso") = "si"
          Response.Redirect("~/WC_ABM_Cubiertas/Cubiertas_op4a.aspx")
        Else
          txt_opcion.Focus()
        End If
  ...
  Private Sub LinkButton_op1_Click(sender As Object, e As EventArgs) Handles LinkButton_op1.Click
    Session("op_ingreso") = "si"
    Response.Redirect("~/WC_ABM_Cubiertas/Cubiertas_op1a.aspx")
  End Sub

  Private Sub LinkButton_op2_Click(sender As Object, e As EventArgs) Handles LinkButton_op2.Click
    Session("op_ingreso") = "si"
    Response.Redirect("~/WC_ABM_Cubiertas/Cubiertas_op2a.aspx")
  End Sub

  Private Sub LinkButton_op3_Click(sender As Object, e As EventArgs) Handles LinkButton_op3.Click
    Session("op_ingreso") = "si"
    Response.Redirect("~/WC_ABM_Cubiertas/Cubiertas_op3a.aspx")
  End Sub

  Private Sub LinkButton_op4_Click(sender As Object, e As EventArgs) Handles LinkButton_op4.Click
    Session("op_ingreso") = "si"
    Response.Redirect("~/WC_ABM_Cubiertas/Cubiertas_op4a.aspx")
  End Sub
End Class
