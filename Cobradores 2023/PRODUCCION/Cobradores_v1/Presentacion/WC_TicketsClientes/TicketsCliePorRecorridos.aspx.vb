Public Class TicketsCliePorRecorridos
    ...
    If ds_usu.Tables(0).Rows.Count <> 0 Then
      ...
      Select Case Jerarquia
        ...
        Case "2"
          ...
          'para este formulario deberia existir debe indicar en Permisos.Opcion = 1 or null y Subopcion 2 or null
          ...
          While i < ds_permisos.Tables(0).Rows.Count
            ...
            If (Menu = "G" And Opcion = "") Or (Menu = "G" And Opcion = "1") Then
              If (SubOpcion = "") Or (SubOpcion = "2") Then
                valido = "si"
                '/////GRUPOS////////
