Public Class TicketsClieRegenerar_orden
...
#End Region
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    If Not IsPostBack Then
      Permisos
      'VALIDACION: Verificar en BD cual es la liquidacion en tabla PARAMETRO, donde el campo Estado= "Inactivo" en base a la fecha ingresada x el operador.
          ...
          While i < ds_permisos.Tables(0).Rows.Count
            ...
            If (Menu = "G" And Opcion = "") Or (Menu = "G" And Opcion = "1") Then
              ...
              If (SubOpcion = "") Or (SubOpcion = "3") Then
                If (SSOpcion = "" Or (SSOpcion = "1")) Then
                  valido = "si"
                  '/////GRUPOS////////
