<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="TicketsClientes.aspx.vb" Inherits="Presentacion.TicketsClientes" %>
...
<div class="card-header">
                <h3 class="card-title">TICKETS CLIENTES.</h3>
</div>
<form role="form">
<div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-2" id="Div_Op1" runat="server" visible ="false">
                            ...
                            <asp:LinkButton ID="LinkButton_GenerarArchivos" runat="server">1 - GENERAR ARCHIVOS.</asp:LinkButton>
                        </div>
                        <div class="col-md-2" id="Div_Op2" runat="server" visible ="false">
                            <asp:LinkButton ID="LinkButton_Imprimir" runat="server">2 - IMPRIMIR.</asp:LinkButton>
