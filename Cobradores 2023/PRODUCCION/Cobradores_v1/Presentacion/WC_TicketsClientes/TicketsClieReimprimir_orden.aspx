<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="TicketsClieReimprimir_orden.aspx.vb" Inherits="Presentacion.TicketsClieReimprimir_orden" %>
...
<ContentTemplate>
    <div class="card card-primary">
        <div class="card-header">
                <h3 class="card-title">REIMPRESION TICKETS CLIENTES POR ORDEN.</h3>
        </div>
    <form role="form">
    <div class="card-body">
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center ">
              ...
              <asp:Button ID="BTN_IMPRIMIR" runat="server" Text="OK" class="btn btn-primary" onkeydown="tecla_op_botones(event);" OnClientClick="window.open('/WC_Reportes/Rpt/TicketsClientesPorOrden/TicketsClientesPorOrden.pdf','_blank')" data-dismiss="modal" />
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
