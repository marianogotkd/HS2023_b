<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="TicketsClientes_op1.aspx.vb" Inherits="Presentacion.TicketsClientes_op1" %>
...
<div class="card-header">
                <h3 class="card-title">TICKETS CLIENTES GENERAR ARCHIVOS.</h3>
</div>
<form role="form">
<div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="row justify-content-center">
                      ...
                      <div class="col-md-2" id="Div_Op3" runat="server" visible ="false">
                            <asp:LinkButton ID="LinkButton_Regenerar" runat="server">3 - REGENERAR.</asp:LinkButton>
                            <%--<asp:Label ID="Label2" runat="server" Text="2 - COBRO."></asp:Label>--%>
                        </div>
