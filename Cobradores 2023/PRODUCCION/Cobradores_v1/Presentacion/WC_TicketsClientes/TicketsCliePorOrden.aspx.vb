...
#End Region
      ...
      'DS_ticketsclientes As New DS_ticketsclientes ---YA ESTA DECLARADO ARRIBA.
      ...
      If ds_ctacte.Tables("Consulta_J2a").Rows.Count <> 0 Then
        ...
        While indice < ds_ctacte.Tables("Consulta_J2a").Rows.Count
          ...
          fila("Cobros") = ds_ctacte.Tables("Consulta_J2a").Rows(indice).Item("Cobros") 'PAGO
          fila("Regalos") = ds_ctacte.Tables("Consulta_J2a").Rows(indice).Item("Regalos") 'PAGO REGALO
          fila("Pagos") = ds_ctacte.Tables("Consulta_J2a").Rows(indice).Item("Pagos") 'DI
          fila("Prestamo") = ds_ctacte.Tables("Consulta_J2a").Rows(indice).Item("Prestamo") 'ENTREGA DE PRESTAMO
          fila("CobPrestamo") = ds_ctacte.Tables("Consulta_J2a").Rows(indice).Item("CobPrestamo") 'DEVOLUCION PRESTAMO
          fila("Credito") = ds_ctacte.Tables("Consulta_J2a").Rows(indice).Item("Credito") 'ENTREGA DE CREDITO
          ...
          If reg_valido = "si" Then
            ...
            Dim grupo_dig As String = CStr(ds_ctacte.Tables("Consulta_J2a").Rows(indice).Item("Grupo_codigo"))
            While grupo_dig.Length < grupo_longitud
              grupo_dig = "0" + grupo_dig
            End While
            Dim cliente_dig As String = CStr(ds_ctacte.Tables("Consulta_J2a").Rows(indice).Item("Cliente_codigo"))
