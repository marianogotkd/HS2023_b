<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="LiquidacionFinal.aspx.vb" Inherits="Presentacion.LiquidacionFinal" %>
...
<div class="card-header">
                <h3 class="card-title">LIQUIDACION FINAL</h3>
</div>
<form role="form">
<div class="card-body">
    <div align="center">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                      <asp:Label ID="Label1" runat="server" Text="ESTA SEGURO DE REALIZAR LA LIQUIDACION FINAL PARA ESTE DIA?"></asp:Label>  
                        <br />
