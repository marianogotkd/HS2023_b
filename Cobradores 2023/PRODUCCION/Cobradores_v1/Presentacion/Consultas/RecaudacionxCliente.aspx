<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="RecaudacionxCliente.aspx.vb" Inherits="Presentacion.RecaudacionxCliente" %>
...
<div class="card-header">
                <h3 class="card-title">RECAUDACION POR CLIENTE</h3>
</div>
<form role="form">
<div class="card-body">
              ...
              <div class="row justify-content-center">
                    ...
                    <div class="card-body table-responsive p-0" style="height: 400px" onkeydown="tecla_op_botones(event);"> <%--div class="form-group"--%>
                            <asp:GridView ID="GridView1" runat="server" class="table table-head-fixed text-nowrap" AllowSorting="True" AutoGenerateColumns="False" 
                                   BorderColor="Black" GridLines="None" ShowHeader="true"  
                                  EnableSortingAndPagingCallbacks="True"> 
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Premios" HeaderText="PREMIOS" >                                                               
                                        </asp:BoundField>
                                      <asp:BoundField DataField="Total" HeaderText="TOTAL" >                                                               
                                        </asp:BoundField>
                                        <asp:BoundField DataField="RecNoTrabajados" HeaderText="RECORRIDOS NO TRABAJADOS" />
...
<div class="form-group">
            ...
            <asp:Button ID="BTN_IMPRIMIR" runat="server" Text="IMPRIMIR" class="btn btn-primary" onkeydown="tecla_op_botones(event);" OnClientClick="window.open('/WC_Reportes/Rpt/RecaudacionxCliente.pdf','_blank')" />
            </div>
