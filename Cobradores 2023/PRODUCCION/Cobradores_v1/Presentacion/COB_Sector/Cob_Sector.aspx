<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Cob_Sector.aspx.vb" Inherits="Presentacion.Cob_Sector" %>
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="row justify-content-center">
                                    <div class="col-md-4">
                                        <label for="Label_cliente_id">LISTADO DE SECTORES REGISTRADOS:</label>
                    ...
                    <div class="card-header">
                              <h3 class="card-title">LISTADO DE SECTORES REGISTRADOS:</h3>      
                    ...
                    <div class="card-body table-responsive p-0" style="height: 400px" onkeydown="tecla_op_botones(event);"> <%--div class="form-group"--%>
                            <asp:GridView ID="GridView1" runat="server" class="table table-head-fixed text-nowrap" AllowPaging="false" AllowSorting="True" AutoGenerateColumns="False" 
                                  ...
                                  EnableSortingAndPagingCallbacks="True"> 
                                    <Columns>
                                        <asp:BoundField DataField="SECTOR_ID" HeaderText="ID" >                                                               
                                        <HeaderStyle ForeColor="#0099FF" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="SECTOR_desc" HeaderText="SECTOR" >                                                               
                                        <HeaderStyle ForeColor="#0099FF" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="CantPasillos" HeaderText="CANT.DE PASILLOS" >                                                               
                                        <HeaderStyle ForeColor="#0099FF" />
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderText="SELECC">
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="Button1" runat="server" Font-Bold="True" ForeColor="Black" 
                                                    Text="IR" Width="70px" CommandName="ID" CommandArgument='<%# Eval("SECTOR_ID") %>' />
                                            </ItemTemplate>
                                            <HeaderStyle ForeColor="#0099FF" />
                                        </asp:TemplateField>
