...
Public Class Conexion
    ...
    ''Dell
    'Public dbconn As New OleDb.OleDbConnection("Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=FitfaWeb;Data Source=STFARGAZ203-L\SQLEXPRESS")
