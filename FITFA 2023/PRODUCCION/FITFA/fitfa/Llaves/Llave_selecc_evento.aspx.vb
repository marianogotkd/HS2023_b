Public Class Llave_selecc_evento
    ...
    Private Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        If (e.CommandName = "ID") Or (e.CommandName = "ID2") Or (e.CommandName = "ID3") Or (e.CommandName = "ID4") Then
                ...
                If id_evento = index Then
                    ...
                    Else
                        ...
                        Else
                            ...
                            Else
                                If (e.CommandName = "ID4") Then
                                    'aqui pongo el response.redirect a llave_disponibles
                                    Response.Redirect("ListadoxCategorias.aspx")
                                End If
