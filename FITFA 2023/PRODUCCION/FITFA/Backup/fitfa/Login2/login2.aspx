<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="login2.aspx.vb" Inherits="fitfa.login2" %>
    ...
    <div>
      ...
      <asp:UpdatePanel ID="upp" runat="server">
       ...
       <div class="form-bottom">
                                ...
                                <asp:TextBox ID="txt_Usuario" runat="server" CssClass="form-username form-control" placeholder="Usuario..."></asp:TextBox>
                                </div>

                                 <div class="form-group">
                                     
                                    <asp:TextBox ID="txt_pass" runat="server" CssClass="form-username form-control" 
			        ...
			        <form role="form" action="" method="post" class="login-form">
                           ...
                           <h3><asp:Label ID="lbl_error" runat="server" 
                                   Text="Los datos ingresados son incorrectos" CssClass="label label-danger" 
                                   Visible="False"></asp:Label></h3>
                                    ...
                                    <button type="submit" ID="Button2" runat="server" class="btn">Inicia!</button>
			        </form>
		   </div>
