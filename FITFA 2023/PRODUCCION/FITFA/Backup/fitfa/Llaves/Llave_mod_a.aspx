<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterPage.Master" CodeBehind="Llave_mod_a.aspx.vb" Inherits="fitfa.Llave_mod_a" %>
...
<div class="card card-primary">
              ...
              <div align="left">
                    ...
                    <table id="tabla" runat="server" align="center" class="style73" 
                                  ...
                                  style="background-image: url('../img/llaves/2x5.jpg'); background-repeat: no-repeat; background-position: center center; table-layout: fixed; width: 500px; height: 500px;">
                        <tr>
                            <td align="center">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <asp:Button ID="B1" runat="server" BackColor="#FF3300" Font-Size="Small" 
                                    ForeColor="White" Height="40px" Text="(0000)" Visible="False" Width="60px" />
                            </td>
                            <td align="center">
                                &nbsp;</td>
                            <td align="center">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <asp:Button ID="B2" runat="server" BackColor="#3399FF" Font-Bold="False" 
                                    Font-Size="Small" ForeColor="White" Height="40px" Text="(0000)" Visible="False" 
                                    Width="60px" />
                            </td>
                            <td align="center">
                                &nbsp;</td>
