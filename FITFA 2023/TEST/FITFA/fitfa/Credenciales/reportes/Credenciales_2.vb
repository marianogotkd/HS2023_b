...
Public Class Credenciales_2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fitfa.Credenciales_2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCredenciales_2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Credenciales_2 = New Credenciales_2()
        rpt.Site = Me.Site
        Return rpt
    End Function
