...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="card card-primary">
                 ...
                 <div class="form-group" id="seccion_area" runat=server >
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group" >
                       ...
                       <asp:Button ID="Button_Agregar" class="btn btn-primary" runat="server" Text="Agregar" />
                  </div>
      ...
      <asp:HiddenField ID="HiddenErrorAreas" runat="server" />
                                ...
                                <div class="card card-success">
                                        ...
                                        <form role="form">
                                            <div class="card-body"> 
                                                    <div class="row">
                                                        <div align="center">
                                                                <asp:Label ID="Label12" runat="server" Text="Error, Las Areas ya fueron asignadas al Evento!"></asp:Label>
                                                        </div>
                                                    </div>
                                            </div>
                                        </form>
