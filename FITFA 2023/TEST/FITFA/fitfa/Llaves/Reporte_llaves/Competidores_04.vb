...
Public Class Competidores_04
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fitfa.Competidores_04.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCompetidores_04
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Competidores_04 = New Competidores_04()
        rpt.Site = Me.Site
        Return rpt
    End Function
