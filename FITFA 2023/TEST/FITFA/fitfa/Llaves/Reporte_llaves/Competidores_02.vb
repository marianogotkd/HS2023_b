...
Public Class Competidores_02
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fitfa.Competidores_02.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCompetidores_02
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Competidores_02 = New Competidores_02()
        rpt.Site = Me.Site
        Return rpt
    End Function
