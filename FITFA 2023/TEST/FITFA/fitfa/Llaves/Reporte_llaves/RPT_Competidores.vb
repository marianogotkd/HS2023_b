...
Public Class RPT_Competidores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fitfa.RPT_Competidores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Competidores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Competidores = New RPT_Competidores()
        rpt.Site = Me.Site
        Return rpt
    End Function
