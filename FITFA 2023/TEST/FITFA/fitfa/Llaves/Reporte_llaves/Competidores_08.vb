...
Public Class Competidores_08
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fitfa.Competidores_08.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCompetidores_08
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Competidores_08 = New Competidores_08()
        rpt.Site = Me.Site
        Return rpt
    End Function
