...
#End Region
    ...
    Private Sub ir_inscripcion(ByVal dni As Integer)

        Dim Estado As String
        Dim ds As DataSet = DAusuario.Usuario_validar_DNI(dni)
    ...
    Private Sub Btn_registrate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btn_registrate.Click
        ...
        If valido = "si" Then
            ...
            If ds_validardni.Tables(0).Rows.Count = 0 Then
                ...
                If CDate(fecha_nacimiento) < fecha_actual Or CDate(fecha_nacimiento) = fecha_actual Then
                    ...
                    If graduacion <> 1 Then
                      ...
                      nrolibreta, "invitado")
                        Dim dni_value As Integer = CInt(Txt_Dni2.Text)

                        limpiar_boxes()

                        ir_inscripcion(dni_value)
            ...
            Else
                'verifico que no haya alguno activo.
                Dim i As Integer = 0
                valido = "si"
                While i < ds_validardni.Tables(0).Rows.Count
                    Dim usuario_obs As String = ""
                    Try
                        usuario_obs = ds_validardni.Tables(0).Rows(i).Item("usuario_obs").ToString
                    Catch ex As Exception

                    End Try

                    If usuario_obs = "" Then 'no es un invitado, por lo tanto no lo actualizo
                        valido = "no"
                        Exit While
                    Else
                        If (ds_validardni.Tables(0).Rows(i).Item("usuario_obs") = "invitado") And (ds_validardni.Tables(0).Rows(i).Item("usuario_estado") = "activo") Then
                ...
                If valido = "si" Then
                    ...
                    If CDate(fecha_nacimiento) < fecha_actual Or CDate(fecha_nacimiento) = fecha_actual Then
                        ...
                        If graduacion <> 1 Then
                            ...
                            Dim usuario_id As Integer = CInt(ds_validardni.Tables(0).Rows(i).Item("usuario_id"))

                            DAusuario.Usuario_modif_invitado(Session("imagen_registro"), apellido, nombre, 2,
                       dni,
                      sexo,
                      "Argentino",
                      1,
                      ...
                      email,
                      graduacion_id, "", Today, instructor_id, "alumno", "", institucion_id,
                      nrolibreta, "invitado", usuario_id)
