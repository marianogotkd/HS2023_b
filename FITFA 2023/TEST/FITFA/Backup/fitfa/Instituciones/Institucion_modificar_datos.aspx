<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterPage.Master" CodeBehind="Institucion_modificar_datos.aspx.vb" Inherits="fitfa.Institucion_modificar_datos" %>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" >
                                        ...
                                        <form role="form">
                                          <div class="card-body"> 
                                            <div class="row">
                                                <div align="center">
                                                    <asp:Label ID="Label16" runat="server" Text="La institución se modificó exitosamente"></asp:Label>
                                                    &nbsp;
                                                </div>
                                            </div>
                                          </div>
